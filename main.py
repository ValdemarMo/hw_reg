...
# или из смски. Добавляем людей в разных мессенджерах. В результате получается адресная
# книга, в которой совершенно невозможно кого-то нормально найти: мешает множество
# дублей и разная запись одних и тех же имен.
#
# Кейс основан на реальных данных из
...
# Необходимо:
#
# поместить Фамилию, Имя и Отчество человека в поля lastname, firstname и
# surname соответственно. В записной книжке изначально может быть Ф + ИО, ФИО,
...
# читаем адресную книгу в форматgit init
# е CSV в список contacts_list
import csv
import re
